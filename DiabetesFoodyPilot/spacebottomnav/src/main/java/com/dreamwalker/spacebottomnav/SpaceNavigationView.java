 ...
 */
package com.dreamwalker.spacebottomnav;
...
import com.dreamwalker.spacebottomnav.R.color;
import com.dreamwalker.spacebottomnav.R.dimen;
import com.dreamwalker.spacebottomnav.R.styleable;
...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int spaceNavigationHeight = (int) getResources().getDimension(dimen.space_navigation_height);
    private final int mainContentHeight = (int) getResources().getDimension(dimen.main_content_height);
    private final int centreContentWight = (int) getResources().getDimension(com.dreamwalker.spacebottomnav.R.dimen.centre_content_width);
    private final int itemContentWight = (int) getResources().getDimension(com.dreamwalker.spacebottomnav.R.dimen.item_content_width);
    private final int centreButtonSize = (int) getResources().getDimension(com.dreamwalker.spacebottomnav.R.dimen.space_centre_button_default_size);
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, com.dreamwalker.spacebottomnav.R.styleable.SpaceNavigationView);
            spaceItemIconSize = typedArray.getDimensionPixelSize(com.dreamwalker.spacebottomnav.R.styleable.SpaceNavigationView_space_item_icon_size, resources.getDimensionPixelSize(dimen.space_item_icon_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_only_size));
            ...
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(dimen.space_item_icon_only_size));
            spaceBackgroundColor = typedArray.getColor(styleable.SpaceNavigationView_space_background_color, resources.getColor(color.space_default_color));
            centreButtonColor = typedArray.getColor(styleable.SpaceNavigationView_centre_button_color, resources.getColor(color.centre_button_color));
            activeSpaceItemColor = typedArray.getColor(styleable.SpaceNavigationView_active_item_color, resources.getColor(color.space_white));
            inActiveSpaceItemColor = typedArray.getColor(styleable.SpaceNavigationView_inactive_item_color, resources.getColor(R.color.default_inactive_item_color));
            ...
            inActiveCentreButtonIconColor = typedArray.getColor(R.styleable.SpaceNavigationView_inactive_centre_button_icon_color, resources.getColor(color.default_inactive_item_color));
            activeCentreButtonBackgroundColor = typedArray.getColor(R.styleable.SpaceNavigationView_active_centre_button_background_color, resources.getColor(color.centre_button_color));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (spaceBackgroundColor == NOT_DEFINED)
            spaceBackgroundColor = ContextCompat.getColor(context,color.space_default_color);

        if (centreButtonColor == NOT_DEFINED)
            centreButtonColor = ContextCompat.getColor(context, color.centre_button_color);

        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.drawable.near_me;

        if (activeSpaceItemColor == NOT_DEFINED)
            activeSpaceItemColor = ContextCompat.getColor(context,color.space_white);

        if (inActiveSpaceItemColor == NOT_DEFINED)
            inActiveSpaceItemColor = ContextCompat.getColor(context, color.default_inactive_item_color);

        if (spaceItemTextSize == NOT_DEFINED)
            spaceItemTextSize = (int) getResources().getDimension(dimen.space_item_text_default_size);

        if (spaceItemIconSize == NOT_DEFINED)
            spaceItemIconSize = (int) getResources().getDimension(dimen.space_item_icon_default_size);

        if (spaceItemIconOnlySize == NOT_DEFINED)
            spaceItemIconOnlySize = (int) getResources().getDimension(dimen.space_item_icon_only_size);

        if (centreButtonRippleColor == NOT_DEFINED)
            centreButtonRippleColor = ContextCompat.getColor(context,color.colorBackgroundHighlightWhite);
        ...
        if (inActiveCentreButtonIconColor == NOT_DEFINED)
            inActiveCentreButtonIconColor = ContextCompat.getColor(context, color.default_inactive_item_color);
