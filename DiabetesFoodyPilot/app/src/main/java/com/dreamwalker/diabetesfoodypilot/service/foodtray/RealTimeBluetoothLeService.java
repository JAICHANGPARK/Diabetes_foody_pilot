...
package com.dreamwalker.diabetesfoodypilot.service.foodtray;
...
import com.dreamwalker.diabetesfoodypilot.device.foodtray.SampleGattAttributes;
 ...
 */
public class RealTimeBluetoothLeService extends Service {
    private final static String TAG = RealTimeBluetoothLeService.class.getSimpleName();
...
//                    dataResultDescriptor = false; // TODO: 2018-09-05 콜백이 다시 발생하면 다시 시간 동기화를 진행하기때문에 플레그를 끈다.
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        } else if (SampleGattAttributes.BLE_CHAR_CUSTOM_TRAY.equals(characteristic.getUuid())) {
...
//            intent.putExtra(EXTRA_DATA, values + "g");
    ...
    public class LocalBinder extends Binder {
        public RealTimeBluetoothLeService getService() {
            return RealTimeBluetoothLeService.this;
        }
    }
    ...
    private boolean enableResultNotification(final BluetoothGatt gatt) {
        ...
        final BluetoothGattDescriptor d = mTreadmillCharacteristic.getDescriptor(SampleGattAttributes.BLE_DESCRIPTOR_DESCRIPTOR);
    ...
    private boolean enableRealtimeNotification(final BluetoothGatt gatt) {
        ...
        Log.e(TAG, "enableResultNotification: " + notiResult);
        final BluetoothGattDescriptor d = mRealtimeCharacteristic.getDescriptor(SampleGattAttributes.BLE_DESCRIPTOR_DESCRIPTOR);
        d.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
        boolean result = gatt.writeDescriptor(d);
        return result;
    }
